    ...
    <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm space-y-4 animate-fadeIn" id="menu-content-customer-crm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {filtered.length === 0 ? (
          ...
          filtered.map(c => (
            <div key={c.id} className="p-4 bg-white border border-slate-150 rounded-2xl shadow-3xs hover:shadow-2xs hover:border-sky-300 transition space-y-3 flex flex-col justify-between">
              ...
              <div className="pt-2 border-t border-slate-100 flex gap-1.5 justify-end">
                <button
                  ...
                  className="px-2.5 py-1.5 bg-slate-50 hover:bg-slate-100 text-slate-700 border border-slate-205 rounded-lg text-[10px] font-bold transition cursor-pointer"
                >
                  ✏️ Edit Profil
                </button>
