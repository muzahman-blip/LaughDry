...
export default function App() {
  ...
  const [isTrackingOnly] = useState<boolean>(() => {
    ...
    const queryTracking = window.location.search.includes('mode=tracking') || window.location.search.includes('phone=') || window.location.search.includes('invoice=');
        ...
        <AnimatePresence mode="wait">
          ...
          {activeConsole === 'pelanggan' && (
            <motion.div
              ...
              className="w-full"
            >
              <CustomerTracking isInitialSyncCompleted={!isSyncing} />
            </motion.div>
          )}
